...
var style_Geometriasimplificada1simplificado_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Datos finales QGIS 2024 julio_Total Crimenes 2024");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 4.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.000000 && value <= 17.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 50.000000 && value <= 189.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 189.000000 && value <= 23658.000000) {
            style = [ new ol.style.Style({
